    ...
    <section className="create-section">
      <div className="create-section-container">
        <div className="create-img-container">
          <img className="create-img" src="https://images.unsplash.com/photo-1606188074044-fcd750f6996a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80" />
        </div>
